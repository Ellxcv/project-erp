...
@section('content')
    <div class="container-fluid">
        <form action="{{ url('/bahanedit/edit/' . $produk->id) }}" method="post" enctype="multipart/form-data">
            {{ csrf_field() }}
            {{ method_field('PUT') }}
            <div class="row mb-3">
            ...
            <div class="row mb-3">
                <label class="col-sm-2 col-form-label">Harga Bahan</label>
                <div class="col-sm-10">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input type="number" class="form-control" id="qty" name="qty" value="{{ $produk->qty }}">
                </div>
            </div>
            <div class="row mb-3">
